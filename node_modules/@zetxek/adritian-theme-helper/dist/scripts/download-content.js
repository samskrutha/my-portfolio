...
exports.adrianDownloadContent = adrianDownloadContent;
...
function copyFiles(files) {
    files.forEach((file) => {
        ...
        if (fs.existsSync(sourcePath)) {
            ...
            (0, child_process_1.execSync)(`cp ${sourcePath} ${targetPath}`);
        }
        else {
...
function adrianDownloadContent(dirsToDownload = ALL_DIRS) {
    try {
        ...
        (0, child_process_1.execSync)(`git clone --depth 1 ${REPO_URL} ${TEMP_DIR}`);
        ...
        dirsToDownload
            ...
            if (fs.existsSync(sourcePath)) {
                ...
                (0, child_process_1.execSync)(`cp -r ${sourcePath} ${targetPath}`);
            }
            else {
        ...
        (0, child_process_1.execSync)(`rm -rf ${TEMP_DIR}`);
